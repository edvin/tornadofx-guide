...
Notice how the `textValue` is automatically bound to the textfield just by referencing it in the `textfield` builder. As an alternative, you could have created a
