...
You can also provide it an `ObservableList` of items up front and omit the type declaration since it can be inferred. Using an ObservableList also has the benefit that changes to the list will auotmatically be reflected in the ListView.
