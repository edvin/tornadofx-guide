...
Some CSS properties accept multiple values, and TornadoFX Stylesheets can streamline this inline with the `multi()` function. For instance, you can nest multiple background colors and insets into a control. 
