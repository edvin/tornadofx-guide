...
Note also you can select multiple component types. For example, you can set the font size of labels and buttons to 20 pixels, on top of other components' declared styles.
