...
If you want to style controls by their type, you can save yourself hte effort
    }
}
```
...
TornadoFX also supports modifier selections by leveraging `add()` functions within a selection. The most common case this is handy is styling for "selected" and cursor "hover" contexts for a control.
