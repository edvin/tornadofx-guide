...
You can also optionally provide keyboard shortcuts, graphics, as well as a lambda for each `menuitem()` to specify the action when it is clicked (Figure 7.14).
